// CAREERFLOW: Phase 2 — system prompt for the reply-draft generator. Four
// intents (reply, follow-up, thank-you, confirm). The model produces ONLY the
// body. Subject is optional and signature is never included — the user appends
// their own. Output never sent automatically: PRD §9.5 hard constraint.
...
The user picks one of four intents per call. Match the tone to the intent.
